...
typedef enum {
    ...
    IMPORT_MODAL_STATE_DB_INIT_PROCESSING_DONE,
    IMPORT_MODAL_STATE_DB_INIT_MERGING,
    ...
    IMPORT_MODAL_STATE_POST_PROCESSING_STANDUP,
...
void add_music_import_db_init_merge_standup( import_modal_state_t * state );
void add_music_import_db_init_merging( import_modal_state_t * state );
...
void add_music_import_post_processing_standup( import_modal_state_t * state );
