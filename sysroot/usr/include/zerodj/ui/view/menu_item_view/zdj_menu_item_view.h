...
// void zdj_menu_item_static_hmi_open_view( zdj_view_t * view, void * _event );
// void zdj_menu_item_static_hmi_open_menu( zdj_view_t * view, void * _event );
// void zdj_menu_item_static_hmi_toggle( zdj_view_t * view, void * _event );
// void zdj_menu_item_static_hmi_input( zdj_view_t * view, void * _event );
