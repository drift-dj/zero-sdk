...
void zdj_activate_control_map( zdj_control_map_id_t map_id ) {
    ...
    switch ( map_id ) {
        ...
        case ZDJ_CONTROL_MAP_STATION_EXT_MOM_EQ:
            zdj_activate_control( ZDJ_DECK_CONTROL_LR_VOL );
            zdj_activate_control( ZDJ_DECK_EXT_CONTROL_PLAY_PAUSE );
            zdj_activate_control( ZDJ_DECK_EXT_CONTROL_SCRUB );
            zdj_activate_control( ZDJ_DECK_EXT_CONTROL_TEMPO );
            zdj_activate_control( ZDJ_DECK_EXT_CONTROL_TEMPO_FINE );
