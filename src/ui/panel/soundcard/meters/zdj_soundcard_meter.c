...
zdj_soundcard_meter_label_t zdj_meter_label_for_node( zdj_soundcard_node_t * node ) {
    switch ( node->name ) {
        ...
        case ZDJ_SOUNDCARD_NODE_NAME_DECK_1_PREFADE: return ZDJ_SOUNDCARD_LABEL_DECK_1_BUS;
        case ZDJ_SOUNDCARD_NODE_NAME_DECK_2_PREFADE: return ZDJ_SOUNDCARD_LABEL_DECK_2_BUS;
        case ZDJ_SOUNDCARD_NODE_NAME_DECK_EXT_PREFADE: return ZDJ_SOUNDCARD_LABEL_DECK_EXT_BUS;
        ...
        case ZDJ_SOUNDCARD_NODE_NAME_XPORT_0: return ZDJ_SOUNDCARD_LABEL_CLOCK_1;
        case ZDJ_SOUNDCARD_NODE_NAME_XPORT_1: return ZDJ_SOUNDCARD_LABEL_CLOCK_2;
        case ZDJ_SOUNDCARD_NODE_NAME_XPORT_2: return ZDJ_SOUNDCARD_LABEL_CLOCK_3;
        case ZDJ_SOUNDCARD_NODE_NAME_XPORT_3: return ZDJ_SOUNDCARD_LABEL_CLOCK_4;
...
zdj_ui_asset_t zdj_meter_asset_for_label( zdj_soundcard_meter_label_t label ) {
    switch ( label ) {
        ...
        case ZDJ_SOUNDCARD_LABEL_DECK_1_BUS: return ZDJ_UI_ASSET_MIXER_DECK_1;
        case ZDJ_SOUNDCARD_LABEL_DECK_2_BUS: return ZDJ_UI_ASSET_MIXER_DECK_2;
        case ZDJ_SOUNDCARD_LABEL_DECK_EXT_BUS: return ZDJ_UI_ASSET_MIXER_DECK_EXT;
        ...
        case ZDJ_SOUNDCARD_LABEL_CLOCK_1: return ZDJ_UI_ASSET_MIXER_CLOCK_BUS;
        case ZDJ_SOUNDCARD_LABEL_CLOCK_2: return ZDJ_UI_ASSET_MIXER_CLOCK_BUS;
        case ZDJ_SOUNDCARD_LABEL_CLOCK_3: return ZDJ_UI_ASSET_MIXER_CLOCK_BUS;
        case ZDJ_SOUNDCARD_LABEL_CLOCK_4: return ZDJ_UI_ASSET_MIXER_CLOCK_BUS;
