...
zdj_view_t * zdj_new_assist_panel( void ) {
...
static void _refresh_menu( zdj_view_t * view ) {
    ...
    zdj_menu_view_add_section( state->menu, zdj_new_menu_section( "Voice Settings" ) );
    zdj_menu_view_add_item( state->menu, zdj_new_menu_item( "Enabled", ZDJ_MENU_ITEM_LAYOUT_BASIC_R ) );
    zdj_menu_view_add_item( state->menu, zdj_new_menu_item( "Routing", ZDJ_MENU_ITEM_LAYOUT_BASIC_R ) );
    zdj_menu_view_add_item( state->menu, zdj_new_menu_item( "Rate", ZDJ_MENU_ITEM_LAYOUT_BASIC_R ) );
    
    zdj_menu_view_add_section( state->menu, zdj_new_menu_section( "Hotkeys" ) );
    zdj_menu_view_add_item( state->menu, zdj_new_menu_item( "Toggle Recording", ZDJ_MENU_ITEM_LAYOUT_BASIC_R ) );
    zdj_menu_view_add_item( state->menu, zdj_new_menu_item( "Toggle Panels", ZDJ_MENU_ITEM_LAYOUT_BASIC_R ) );
    zdj_menu_view_add_item( state->menu, zdj_new_menu_item( "Screencap", ZDJ_MENU_ITEM_LAYOUT_BASIC_R ) );
