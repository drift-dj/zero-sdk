...
static void _zdj_soundcard_options_cv_handle_pad( zdj_view_t * view, zdj_control_event_t * _event );
static void _zdj_soundcard_options_cv_handle_stereo( zdj_view_t * view, zdj_control_event_t * _event );
static void _zdj_soundcard_options_cv_handle_mute( zdj_view_t * view, zdj_control_event_t * _event );
static void _zdj_soundcard_options_cv_handle_linkage( zdj_view_t * view, zdj_control_event_t * _event );
static void _zdj_soundcard_options_cv_handle_scope( zdj_view_t * view, zdj_control_event_t * _event );
static void _zdj_soundcard_options_cv_cb( void * _context );
...
void zdj_soundcard_options_cv_hmi( zdj_view_t * view, zdj_control_event_t * _event ) {
    ...
    zdj_soundcard_node_t * node = options_state->config_context->node;

    e->blocked = true;

    printf( "zdj_soundcard_options_cv_hmi: %d\n", menu_state->scroll_index );
...
void zdj_soundcard_options_update_cv_layout( zdj_view_t * view ) {
    ...
    //     stereo->handle_control_event = &_zdj_soundcard_options_cv_handle_stereo;
    ...
    mute->handle_control_event = &_zdj_soundcard_options_cv_handle_mute;
    ...
    scope->handle_control_event = &_zdj_soundcard_options_cv_handle_scope;
    ...
    options_state->menu_index_scope = options_state->menu_index_mute + 1;
    ...
    if( out_node_count ) {
        for( int i=0; i<out_node_count; i++ ) {
            ...
            output->handle_control_event = &_zdj_soundcard_options_cv_handle_linkage;
    ...
    add_output->handle_control_event = &_zdj_soundcard_options_cv_handle_linkage;
...
void _zdj_soundcard_options_cv_cb( void * _context ) {
    ...
    if ( context->remove_node_selection ) {
        printf( "_zdj_soundcard_options_cv_cb remove: %s -> %s\n",
        ...
        printf( "_zdj_soundcard_options_cv_cb add/edit: %s -> %s\n",
            zdj_soundcard_node_name[ context->node->name ],
...
void _zdj_soundcard_options_cv_handle_stereo( zdj_view_t * view, zdj_control_event_t * _event ) {
...
void _zdj_soundcard_options_cv_handle_mute( zdj_view_t * view, zdj_control_event_t * _event ) {
    zdj_menu_item_view_state_t * stereo_state = (zdj_menu_item_view_state_t*)view->state;
    zdj_soundcard_options_state_t * options_state = (zdj_soundcard_options_state_t*)stereo_state->data->ptr;
    // Toggle the node's stereo val and tell main screen to redraw with new vals
...
void _zdj_soundcard_options_cv_handle_scope( zdj_view_t * view, zdj_control_event_t * _event ) {
...
void _zdj_soundcard_options_cv_handle_linkage( zdj_view_t * view, zdj_control_event_t * _event ) {
    printf( "_zdj_soundcard_options_cv_handle_linkage\n" );
    zdj_menu_item_view_state_t * state = (zdj_menu_item_view_state_t*)view->state;
    zdj_soundcard_options_state_t * options_state = state->data->ptr;
    options_state->config_context->options_view_cb = _zdj_soundcard_options_cv_cb;
