...
static void _zdj_soundcard_options_clock_handle_mute( zdj_view_t * view, zdj_control_event_t * _event );
static void _zdj_soundcard_options_clock_handle_linkage( zdj_view_t * view, zdj_control_event_t * _event );
static void _zdj_soundcard_options_clock_cb( void * _context );
...
void zdj_soundcard_options_clock_hmi( zdj_view_t * view, zdj_control_event_t * _event ) {
    ...
    printf( "zdj_soundcard_options_clock_hmi: %d\n", menu_state->scroll_index );
...
void zdj_soundcard_options_update_clock_layout( zdj_view_t * view ) {
    ...
    mute->handle_control_event = &_zdj_soundcard_options_clock_handle_mute;
    ...
    options_state->menu_index_mute = 0;
    ...
    if( out_node_count ) {
        for( int i=0; i<out_node_count; i++ ) {
            ...
            output->handle_control_event = &_zdj_soundcard_options_clock_handle_linkage;
    ...
    add_output->handle_control_event = &_zdj_soundcard_options_clock_handle_linkage;
...
void _zdj_soundcard_options_clock_cb( void * _context ) {
...
void _zdj_soundcard_options_clock_handle_mute( zdj_view_t * view, zdj_control_event_t * _event ) {
...
void _zdj_soundcard_options_clock_handle_linkage( zdj_view_t * view, zdj_control_event_t * _event ) {
    ...
    options_state->config_context->options_view_cb = _zdj_soundcard_options_clock_cb;
