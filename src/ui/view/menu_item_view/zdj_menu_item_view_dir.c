...
void zdj_menu_item_dir_init_layout( zdj_view_t * view ) {
    ...
    title_ticker_norm->frame->w = view->frame->w - ZDJ_MENU_ITEM_MARGIN_L - ZDJ_MENU_ITEM_MARGIN_R - 11;
    ...
    folder_icon->frame->x = view->frame->w - 10;
    folder_icon->frame->y = 1;
    
    // Setup hilite view
    zdj_view_t * hilite_bg = zdj_new_asset_view( &zdj_ui_assets[ ZDJ_UI_ASSET_HILITE_9_L ], NULL );
    zdj_add_subview( state->hilite_view, hilite_bg );
    hilite_bg->frame->y = 0;
    hilite_bg->frame->w = view->frame->w;
    zdj_view_t * hilite_bg_r = zdj_new_asset_view( &zdj_ui_assets[ ZDJ_UI_ASSET_HILITE_9_R ], NULL );
    ...
    title_ticker_hilite->frame->w = view->frame->w - ZDJ_MENU_ITEM_MARGIN_L - ZDJ_MENU_ITEM_MARGIN_R - 11;
    ...
    folder_icon_hi->frame->x = view->frame->w - 10;
    folder_icon_hi->frame->y = 1;
