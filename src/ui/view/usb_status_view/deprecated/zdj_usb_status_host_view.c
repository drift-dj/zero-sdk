...
#include <zerodj/usb/device/zdj_usb_device.h>

// static void _handle_device_mode_btn( zdj_view_t * view, void * _event );
// static void _handle_host_mode_btn( zdj_view_t * view, void * _event );
// static void _handle_offline_btn( zdj_view_t * view, void * _event );
...
// void _handle_device_mode_btn( zdj_view_t * view, void * _event ) {
